...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var passwordHash, category;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, bcryptjs_1.default.hash("staff123", 10)];
                case 1:
                ...
                case 4:
                    ...
                    return [4 /*yield*/, prisma.product.createMany({
                            data: [
                                { name: "Coke", price: 150, categoryId: category.id },
                                { name: "Pepsi", price: 140, categoryId: category.id },
                            ],
                        })];
                case 5:
                    _a.sent();
